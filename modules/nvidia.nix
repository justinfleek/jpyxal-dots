...

{
  ...
  home.packages = with pkgs; [
    # CUDA toolkit (cuda-merged includes cudnn, cutensor, nccl)
    cudaPackages.cudatoolkit
    # cudaPackages.cudnn       # Conflicts with cuda-merged LICENSE
    # cudaPackages.libcutensor # Conflicts with cuda-merged LICENSE
    # cudaPackages.nccl        # Conflicts with cuda-merged LICENSE
